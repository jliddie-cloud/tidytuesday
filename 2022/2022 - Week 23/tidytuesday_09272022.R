...
ggplot(state.summaries, aes(x = type.clean, y = value)) +
  ...
  theme(plot.title = element_markdown(margin = margin(t = 10, b = 20), hjust = 0, 
        ...
        axis.text.x = element_text(size = 25, color = "black", family = "Kanit"),
        strip.text.x = element_text(size = 35, family = "Kanit"),
...
ggsave("2022/2022 - Week 23/artists.png", dpi = 600, width = 8, height = 6, bg = "white")
