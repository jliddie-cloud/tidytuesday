...
ggmap(sf_basemap) +
  ...
  theme(
        ...
        plot.title = element_text(size = 44, hjust = 0, family = "Patua One"),
        strip.text = element_text(size = 30, family = "Patua One"),
        plot.caption = element_text(size = 20, hjust = 0, family = "Patua One", margin=margin(t=0.5))
        )

ggsave("2022/2022 - Week 16/sf_rents.png", dpi = 600, width = 4, height = 5,
       bg = "white")        
